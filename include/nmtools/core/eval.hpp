...
namespace nmtools
{
    ...
    struct evaluator_t<view_t,unroll_t,resolver_t>
    {
        ...
        using output_type  = meta::resolve_optype_t<resolver_t,view_t,unroll_t>;
...
namespace nmtools::meta
{
    ...
    constexpr auto resolve_unary_array_type(as_value<array_t>, as_value<view_type>)
    {
        ...
        if constexpr (
            ...
            using type = typename make_hybrid_ndarray<element_t,max_size,dim>::type;
            ...
            using type = typename make_fixed_ndarray<element_t,shape_t>::type;
            return as_value_v<type>;
        } else if constexpr (
                is_num_v<view_type>
            ...
            constexpr auto dim = fixed_dim_v<view_type>;
            using type = typename make_hybrid_ndarray<element_t,max_elements,dim>::type;
            return as_value_v<type>;
        } else {
            // fail
