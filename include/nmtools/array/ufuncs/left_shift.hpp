#ifndef NMTOOLS_ARRAY_UFUNCS_LEFT_SHIFT_HPP
#define NMTOOLS_ARRAY_UFUNCS_LEFT_SHIFT_HPP
...
namespace nmtools::view::fun
{
    ...
    struct left_shift<none_t,none_t,res_t,
...
namespace nmtools::view
{
    template <
        ...
        typename res_t=none_t
    >
    using left_shift_t = fun::left_shift<lhs_t,rhs_t,res_t>;

    template <typename left_t, typename right_t, typename casting_t=casting::auto_t>
    constexpr auto left_shift(const left_t& a, const right_t& b, casting_t=casting_t{})
    {
        ...
        if constexpr (cast_kind == Casting::AUTO) {
            ...
            return broadcast_binary_ufunc(left_shift_t<lhs_t,rhs_t,rhs_t>{},a,b);
        }
    ...
    constexpr auto reduce_left_shift(const left_t& a, const args::reduce<axis_t,dtype_t,initial_t,keepdims_t,op_t>& attributes)
    {
        return reduce_left_shift(a
            , attributes.axis
            , attributes.dtype
            , attributes.initial
            , attributes.keepdims
...
namespace nmtools::utils::impl
{
    template <
        ...
        auto...fmt_args
    >
    struct to_string_t<view::fun::left_shift<lhs_t,rhs_t,res_t>,fmt_string_t<fmt_args...>>
    {
        using result_type = nmtools_string;

        auto operator()(view::fun::left_shift<lhs_t,rhs_t,res_t>) const
        {
...
namespace nmtools::functional
{
    namespace fun
    {
        using left_shift            = fun::broadcast_binary_ufunc<view::left_shift_t<>>;
        using reduce_left_shift     = fun::reduce<view::left_shift_t<>>;
        using outer_left_shift      = fun::outer<view::left_shift_t<>>;
        using accumulate_left_shift = fun::accumulate<view::left_shift_t<>>;
    }

    constexpr inline auto left_shift = functor_t{binary_fmap_t<fun::left_shift>{}};
    constexpr inline auto reduce_left_shift = functor_t{unary_fmap_t<fun::reduce_left_shift>{}};
    constexpr inline auto outer_left_shift = functor_t{binary_fmap_t<fun::outer_left_shift>{}};
    constexpr inline auto accumulate_left_shift = functor_t{unary_fmap_t<fun::accumulate_left_shift>{}};
} // namespace nmtools::functional
...
namespace nmtools::array
{
    ...
    {
        auto left_shift_view = view::reduce_left_shift(a,axis,dtype,initial,keepdims,where);
        return eval(left_shift_view
    ...
    constexpr auto accumulate_left_shift(const left_t& a, const axis_t& axis, dtype_t dtype=dtype_t{}
        , context_t&& context=context_t{}, output_t&& output=output_t{},meta::as_value<resolver_t> resolver=meta::as_value_v<resolver_t>)
    {
        auto left_shift_view = view::accumulate_left_shift(a,axis,dtype);
        return eval(left_shift_view
            , nmtools::forward<context_t>(context)
            , nmtools::forward<output_t>(output)
            , resolver
    ...
    constexpr auto outer_left_shift(const left_t& a, const right_t& b, dtype_t dtype=dtype_t{}
        , context_t&& context=context_t{}, output_t&& output=output_t{},meta::as_value<resolver_t> resolver=meta::as_value_v<resolver_t>)
    {
        auto left_shift_view = view::outer_left_shift(a,b,dtype);
        return eval(left_shift_view
            , nmtools::forward<context_t>(context)
            , nmtools::forward<output_t>(output)
            , resolver
    ...
    namespace fn
    {
        struct left_shift
        {
            ...
            {
                auto left_shift_view = view::left_shift(a,b);
                return eval(left_shift_view
                    , nmtools::forward<context_t>(context)
                    , nmtools::forward<output_t>(output)
                    , resolver
            ...
            inline constexpr auto operator()(const left_t& a, const right_t& b, casting::same_kind_t casting_type
                , context_t&& context=context_t{}, output_t&& output=output_t{},meta::as_value<resolver_t> resolver=meta::as_value_v<resolver_t>) const
            {
                auto left_shift_view = view::left_shift(a,b,casting_type);
                return eval(left_shift_view
                    , nmtools::forward<context_t>(context)
                    , nmtools::forward<output_t>(output)
                    , resolver
            ...
            static constexpr auto reduce(const left_t& a, const axis_t& axis, dtype_t dtype=dtype_t{}
                ...
                , context_t&& context=context_t{}, output_t&& output=output_t{},meta::as_value<resolver_t> resolver=meta::as_value_v<resolver_t>)
            {
                return array::reduce_left_shift(a,axis,dtype,initial,keepdims,where
                    , nmtools::forward<context_t>(context)
                    , nmtools::forward<output_t>(output)
                    , resolver
                );
            ...
            static constexpr auto accumulate(const left_t& a, const axis_t& axis, dtype_t dtype=dtype_t{}
                , context_t&& context=context_t{}, output_t&& output=output_t{},meta::as_value<resolver_t> resolver=meta::as_value_v<resolver_t>)
            {
                return array::accumulate_left_shift(a,axis,dtype
                    , nmtools::forward<context_t>(context)
                    , nmtools::forward<output_t>(output)
                    , resolver
                );
            ...
            static constexpr auto outer(const left_t& a, const right_t& b, dtype_t dtype=dtype_t{}
                , context_t&& context=context_t{}, output_t&& output=output_t{},meta::as_value<resolver_t> resolver=meta::as_value_v<resolver_t>)
            {
                return array::outer_left_shift(a,b,dtype
                    , nmtools::forward<context_t>(context)
                    , nmtools::forward<output_t>(output)
                    , resolver
                );
...
#endif // NMTOOLS_ARRAY_UFUNCS_LEFT_SHIFT_HPP