...
namespace nmtools::view
{
    ...
    constexpr auto cumsum(const array_t& a, axis_t axis=axis_t{}, dtype_t=dtype_t{})
    {
...
namespace nmtools
{
    ...
    constexpr auto cumsum(const array_t& a, axis_t axis=axis_t{}, dtype_t dtype=dtype_t{},
