#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_ISINF_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_ISINF_HPP
...
#define nmtools_cl_kernel_bin isinf_spv
#define nmtools_cl_kernel_len isinf_spv_len
#define nmtools_cl_ufunc_name isinf
#define nmtools_cl_ufunc_type isinf_t
#define nmtools_cl_kernel_name(out_type, inp_type) isinf##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(isinf##_##out_type##_##inp_type)
#endif
...
nmtools_cl_kernel(bool,float)
nmtools_cl_kernel(bool,double)
...
namespace nmtools::array::opencl
{
    ...
    #endif
    {
        ...
        static auto kernel_name()
        {
            ...
            if constexpr (meta::is_same_v<out_t,bool> && meta::is_same_v<inp_t,float>) {
                return nmtools_cl_kernel_name_str(bool,float);
            } else /* if constexpr (meta::is_same_v<out_t,double> && meta::is_same_v<inp_t,double>) */ {
                return nmtools_cl_kernel_name_str(bool,double);
            }
        }
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_ISINF_HPP