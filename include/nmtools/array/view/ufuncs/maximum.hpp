...
namespace nmtools::view
{
    ...
    constexpr auto reduce_maximum(const left_t& a, const axis_t& axis, dtype_t, initial_t initial, keepdims_t keepdims)
    {
    ...
    constexpr auto reduce_maximum(const left_t& a, const axis_t& axis, dtype_t, initial_t initial)
    {
        using res_t = get_dtype_t<dtype_t>;
        using op_t  = maximum_t<none_t,none_t,res_t>;
    ...
    template <typename left_t, typename axis_t, typename dtype_t>
    auto accumulate_maximum(const left_t& a, const axis_t& axis, dtype_t)
    {
        using res_t = get_dtype_t<dtype_t>;
        using op_t  = maximum_t<none_t,none_t,res_t>;
    ...
    constexpr auto outer_maximum(const left_t& a, const right_t& b, dtype_t=dtype_t{})
    {
        using res_t = get_dtype_t<dtype_t>;
        using op_t  = maximum_t<none_t,none_t,res_t>;
