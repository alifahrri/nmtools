...
namespace nmtools::view
{
    ...
    constexpr auto broadcast_arrays(const arrays_t&...arrays)
    {
        ...
        using result_t = nmtools_tuple<decltype(broadcast_to(meta::declval<arrays_t>(),meta::declval<bcast_result_t>(),meta::declval<bsize_t>()))...>;
        ...
        return return_t{result_t{broadcast_to(arrays,*result,bsize)...}};
    } // broadcast_arrays
} // namespace nmtools::view
