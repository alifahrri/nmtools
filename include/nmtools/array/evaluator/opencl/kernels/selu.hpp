#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SELU_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SELU_HPP
...
#define nmtools_cl_kernel_bin selu_spv
#define nmtools_cl_kernel_len selu_spv_len
#define nmtools_cl_ufunc_name selu
#define nmtools_cl_ufunc_type selu_t
#define nmtools_cl_kernel_name(out_type, inp_type) selu##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(selu##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SELU_HPP