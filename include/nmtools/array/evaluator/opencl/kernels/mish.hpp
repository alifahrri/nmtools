#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_MISH_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_MISH_HPP
...
#define nmtools_cl_kernel_bin mish_spv
#define nmtools_cl_kernel_len mish_spv_len
#define nmtools_cl_ufunc_name mish
#define nmtools_cl_ufunc_type mish_t
#define nmtools_cl_kernel_name(out_type, inp_type) mish##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(mish##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_MISH_HPP