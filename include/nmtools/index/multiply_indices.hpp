#ifndef NMTOOLS_INDEX_MULTIPLY_INDICES_HPP
#define NMTOOLS_INDEX_MULTIPLY_INDICES_HPP
...
{
    struct multiply_indices_t {};

    template <typename lhs_indices_t, typename rhs_indices_t>
    constexpr auto multiply_indices(const lhs_indices_t& lhs_indices, const rhs_indices_t& rhs_indices)
    {
        using result_t = resolve_optype_t<multiply_indices_t,lhs_indices_t,rhs_indices_t>;
...
namespace nmtools::meta
{
    ...
    {
        template <typename...>
        struct MULTIPLY_INDICES_UNSUPPORTED : detail::fail_t {};
    }

    template <typename lhs_indices_t, typename rhs_indices_t>
    struct resolve_optype<
        void, index::multiply_indices_t, lhs_indices_t, rhs_indices_t
    > {
        static constexpr auto vtype = [](){
            if constexpr (!is_index_array_v<lhs_indices_t>
                || !is_index_array_v<rhs_indices_t>
            ) {
                using type = error::MULTIPLY_INDICES_UNSUPPORTED<lhs_indices_t,rhs_indices_t>;
                ...
                constexpr auto result = index::multiply_indices(lhs_indices,rhs_indices);
...
#endif // NMTOOLS_INDEX_MULTIPLY_INDICES_HPP