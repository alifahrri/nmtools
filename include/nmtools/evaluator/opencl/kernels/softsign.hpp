#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SOFTSIGN_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SOFTSIGN_HPP
...
#define nmtools_cl_kernel_bin softsign_spv
#define nmtools_cl_kernel_len softsign_spv_len
#define nmtools_cl_ufunc_name softsign
#define nmtools_cl_ufunc_type softsign_t
#define nmtools_cl_kernel_name(out_type, inp_type) softsign##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(softsign##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SOFTSIGN_HPP