#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_LEAKY_RELU_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_LEAKY_RELU_HPP
...
#define nmtools_cl_kernel_bin leaky_relu_spv
#define nmtools_cl_kernel_len leaky_relu_spv_len
#define nmtools_cl_ufunc_name leaky_relu
#define nmtools_cl_ufunc_type leaky_relu_t
#define nmtools_cl_kernel_name(out_type, inp_type) leaky_relu##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(leaky_relu##_##out_type##_##inp_type)
#endif
...
kernel void nmtools_cl_kernel_name(out_type,inp_type)(global out_type* out, global const inp_type* inp, const unsigned long out_size, const unsigned long inp_size, const inp_type negative_slope) \
{                                                    \
    auto ref     = view::ref(inp,inp_size);          \
    auto mut_ref = view::mutable_ref(out,out_size);  \
    auto fn      = view::nmtools_cl_ufunc_name(ref,negative_slope); \
...
namespace nmtools::opencl
{
    ...
    #endif
    {
        ...
        {
            return nmtools_tuple{this->view.op.negative_slope};
        }
        #endif
    }; // kernel_t
}
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_LEAKY_RELU_HPP