...
#define nmtools_cl_ufunc_name relu
#define nmtools_cl_ufunc_type relu_t

// ex: out_type=float, inp_type=float, name=relu; result: relu_float_float
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_RELU_CL_HPP