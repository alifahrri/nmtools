#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SOFTSHRINK_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SOFTSHRINK_HPP
...
#define nmtools_cl_kernel_bin softshrink_spv
#define nmtools_cl_kernel_len softshrink_spv_len
#define nmtools_cl_ufunc_name softshrink
#define nmtools_cl_ufunc_type softshrink_t
#define nmtools_cl_kernel_name(out_type, inp_type) softshrink##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(softshrink##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SOFTSHRINK_HPP