#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_CELU_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_CELU_HPP
...
#define nmtools_cl_ufunc_name celu
#define nmtools_cl_ufunc_type celu_t
#define nmtools_cl_kernel_name(out_type, inp_type) celu##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(celu##_##out_type##_##inp_type)
#endif
...
{                                                    \
    ...
    auto fn      = view::nmtools_cl_ufunc_name(ref,static_cast<inp_type>(alpha)); \
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_CELU_HPP