#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SILU_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SILU_HPP
...
#define nmtools_cl_kernel_bin silu_spv
#define nmtools_cl_kernel_len silu_spv_len
#define nmtools_cl_ufunc_name silu
#define nmtools_cl_ufunc_type silu_t
#define nmtools_cl_kernel_name(out_type, inp_type) silu##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(silu##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SILU_HPP