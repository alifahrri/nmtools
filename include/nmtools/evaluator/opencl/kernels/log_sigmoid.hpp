#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_LOG_SIGMOID_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_LOG_SIGMOID_HPP
...
#define nmtools_cl_kernel_bin log_sigmoid_spv
#define nmtools_cl_kernel_len log_sigmoid_spv_len
#define nmtools_cl_ufunc_name log_sigmoid
#define nmtools_cl_ufunc_type log_sigmoid_t
#define nmtools_cl_kernel_name(out_type, inp_type) log_sigmoid##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(log_sigmoid##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_LOG_SIGMOID_HPP