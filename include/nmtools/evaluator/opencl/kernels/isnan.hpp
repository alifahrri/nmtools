#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_ISNAN_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_ISNAN_HPP
...
#define nmtools_cl_kernel_bin isnan_spv
#define nmtools_cl_kernel_len isnan_spv_len
#define nmtools_cl_ufunc_name isnan
#define nmtools_cl_ufunc_type isnan_t
#define nmtools_cl_kernel_name(out_type, inp_type) isnan##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(isnan##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_ISNAN_HPP