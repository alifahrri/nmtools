#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_ELU_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_ELU_HPP
...
#define nmtools_cl_ufunc_name elu
#define nmtools_cl_ufunc_type elu_t
#define nmtools_cl_kernel_name(out_type, inp_type) elu##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(elu##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_ELU_HPP