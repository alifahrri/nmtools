#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_HARDTANH_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_HARDTANH_HPP
...
#define nmtools_cl_kernel_bin hardtanh_spv
#define nmtools_cl_kernel_len hardtanh_spv_len
#define nmtools_cl_ufunc_name hardtanh
#define nmtools_cl_ufunc_type hardtanh_t
#define nmtools_cl_kernel_name(out_type, inp_type) hardtanh##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(hardtanh##_##out_type##_##inp_type)
#endif
...
kernel void nmtools_cl_kernel_name(out_type,inp_type)(global out_type* out, global const inp_type* inp, const unsigned long out_size, const unsigned long inp_size, const inp_type min_val, const inp_type max_val) \
{                                                    \
    auto ref     = view::ref(inp,inp_size);          \
    auto mut_ref = view::mutable_ref(out,out_size);  \
    auto fn      = view::nmtools_cl_ufunc_name(ref,min_val,max_val); \
...
namespace nmtools::array::opencl
{
    ...
    #endif
    {
        ...
        {
            return nmtools_tuple{this->view.op.min_val,this->view.op.max_val};
        }
        #endif
    }; // kernel_t
}
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_HARDTANH_HPP