#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SIGMOID_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SIGMOID_HPP
...
#define nmtools_cl_kernel_bin sigmoid_spv
#define nmtools_cl_kernel_len sigmoid_spv_len
#define nmtools_cl_ufunc_name sigmoid
#define nmtools_cl_ufunc_type sigmoid_t
#define nmtools_cl_kernel_name(out_type, inp_type) sigmoid##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(sigmoid##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SIGMOID_HPP