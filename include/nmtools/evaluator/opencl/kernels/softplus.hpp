#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SOFTPLUS_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SOFTPLUS_HPP
...
#define nmtools_cl_kernel_bin softplus_spv
#define nmtools_cl_kernel_len softplus_spv_len
#define nmtools_cl_ufunc_name softplus
#define nmtools_cl_ufunc_type softplus_t
#define nmtools_cl_kernel_name(out_type, inp_type) softplus##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(softplus##_##out_type##_##inp_type)
#endif
...
kernel void nmtools_cl_kernel_name(out_type,inp_type)(global out_type* out, global const inp_type* inp, const unsigned long out_size, const unsigned long inp_size, const inp_type beta, const inp_type threshold) \
{                                                    \
    auto ref     = view::ref(inp,inp_size);          \
    auto mut_ref = view::mutable_ref(out,out_size);  \
    auto fn      = view::nmtools_cl_ufunc_name(ref,beta,threshold); \
...
namespace nmtools::array::opencl
{
    ...
    #endif
    {
        ...
        {
            return nmtools_tuple{this->view.op.beta,this->view.op.threshold};
        }
        #endif
    }; // kernel_t
}
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SOFTPLUS_HPP