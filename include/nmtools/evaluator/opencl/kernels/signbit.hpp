#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SIGNBIT_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SIGNBIT_HPP
...
#define nmtools_cl_kernel_bin signbit_spv
#define nmtools_cl_kernel_len signbit_spv_len
#define nmtools_cl_ufunc_name signbit
#define nmtools_cl_ufunc_type signbit_t
#define nmtools_cl_kernel_name(out_type, inp_type) signbit##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(signbit##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNELS_SIGNBIT_HPP