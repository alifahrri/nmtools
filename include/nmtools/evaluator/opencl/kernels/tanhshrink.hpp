#ifndef NMTOOLS_ARRAY_EVAL_OPENCL_KERNEL_TANHSHRINK_HPP
#define NMTOOLS_ARRAY_EVAL_OPENCL_KERNEL_TANHSHRINK_HPP
...
#define nmtools_cl_kernel_bin tanhshrink_spv
#define nmtools_cl_kernel_len tanhshrink_spv_len
#define nmtools_cl_ufunc_name tanhshrink
#define nmtools_cl_ufunc_type tanhshrink_t
#define nmtools_cl_kernel_name(out_type, inp_type) tanhshrink##_##out_type##_##inp_type
#define nmtools_cl_kernel_name_str(out_type, inp_type) nm_stringify(tanhshrink##_##out_type##_##inp_type)
#endif
...
#endif // NMTOOLS_ARRAY_EVAL_OPENCL_KERNEL_TANHSHRINK_HPP