...
NMTOOLS_TESTING_DECLARE_CASE(array, layer_norm)
{
    ...
    {
        inline float result[5] = {-1.414210, -0.707105, 0.000000, 0.707105, 1.414210};
    }

    NMTOOLS_TESTING_DECLARE_ARGS(case5)
    {
        inline int input[2][3] = {
            {0, 1, 2},
            {3, 4, 5}
        };
        inline int weight[3] = {1, 1, 1};
        inline int bias[3]   = {0, 0, 0};
        inline int axis[1]   = {-1};
        NMTOOLS_CAST_ARRAYS(input)
        NMTOOLS_CAST_ARRAYS(weight)
        NMTOOLS_CAST_ARRAYS(bias)
