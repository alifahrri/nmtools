...
NMTOOLS_TESTING_DECLARE_CASE(compute_strides)
{
    ...
    NMTOOLS_TESTING_DECLARE_EXPECT(case2)
    {
        ...
        inline auto result_nl1 = nmtools_array{null_int(2),null_int(1)};
        inline auto result_nl2 = nmtools_array{null_int(),null_int(1)};
    }
    ...
    NMTOOLS_TESTING_DECLARE_ARGS(case3)
    {
        ...
        inline auto shape_nl1 = nmtools_array{null_int(),null_int(2),null_int(1)};
        inline auto shape_nl2 = nmtools_array{null_int(3),null_int(),null_int(1)};
        inline auto shape_mx1 = nmtools_tuple{3,2_ct,1_ct};
        inline auto shape_mx2 = nmtools_tuple{3_ct,2,1_ct};
        NMTOOLS_CAST_INDEX_ARRAYS(shape)
        NMTOOLS_MAYBE_CAST_INDEX_ARRAYS(shape)
    }
    NMTOOLS_TESTING_DECLARE_EXPECT(case3)
    {
        ...
        inline auto result_nl1 = nmtools_array{null_int(2),null_int(1),null_int(1)};
        inline auto result_nl2 = nmtools_array{null_int(),null_int(1),null_int(1)};
    }
    ...
    NMTOOLS_TESTING_DECLARE_ARGS(case4)
    {
        ...
        inline auto shape_nl1 = nmtools_array{null_int(),null_int(2),null_int(3)};
        inline auto shape_nl2 = nmtools_array{null_int(3),null_int(),null_int(3)};
    ...
    NMTOOLS_TESTING_DECLARE_EXPECT(case4)
    {
        ...
        inline auto result_nl1 = nmtools_array{null_int(6),null_int(3),null_int(1)};
        inline auto result_nl2 = nmtools_array{null_int(),null_int(3),null_int(1)};
    }
}
