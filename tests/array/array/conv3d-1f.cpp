...
TEST_CASE("conv3d(case1f)" * doctest::test_suite("array::conv3d"))
{
    ...
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    CONV3D_SUBCASE( case1f, input, weight, bias, stride, padding, dilation, groups_ct );
    CONV3D_SUBCASE( case1f, input_a, weight_a, bias_a, stride, padding, dilation, groups_ct );
    CONV3D_SUBCASE( case1f, input_f, weight_f, bias_f, stride, padding, dilation, groups_ct );
    CONV3D_SUBCASE( case1f, input_h, weight_h, bias_h, stride, padding, dilation, groups );
    CONV3D_SUBCASE( case1f, input_d, weight_d, bias_d, stride, padding, dilation, groups );
    #else
    #endif
}