...
TEST_CASE("conv2d(case8)" * doctest::test_suite("array::conv2dv2"))
{
    ...
    CONV2D_SUBCASE( case8, input_h, weight_h, bias, stride, padding );
    CONV2D_SUBCASE( case8, input_d, weight_d, bias, stride, padding );
    #else
    CONV2D_SUBCASE( case8, input_cs_fb, weight_cs_fb, bias, stride, padding );
    CONV2D_SUBCASE( case8, input_cs_hb, weight_cs_hb, bias, stride, padding );
    ...
    CONV2D_SUBCASE( case8, input_ds_fb, weight_ds_fb, bias, stride, padding );
    CONV2D_SUBCASE( case8, input_ds_hb, weight_ds_hb, bias, stride, padding );
    CONV2D_SUBCASE( case8, input_ds_db, weight_ds_db, bias, stride, padding );

    CONV2D_SUBCASE( case8, input_ls_fb, weight_ls_fb, bias, stride, padding );
