...
TEST_CASE("conv3d(case1c)" * doctest::test_suite("array::conv3d"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    CONV3D_SUBCASE( case1c, input, weight, bias, stride_ct );
    CONV3D_SUBCASE( case1c, input_a, weight_a, bias_a, stride_ct );
    CONV3D_SUBCASE( case1c, input_f, weight_f, bias_f, stride_ct );
    CONV3D_SUBCASE( case1c, input_h, weight_h, bias_h, stride );
    CONV3D_SUBCASE( case1c, input_d, weight_d, bias_d, stride );
    #else
    #endif
}