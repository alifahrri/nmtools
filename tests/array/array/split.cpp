...
// TODO: fix utl vector
/*
error: use of deleted function ‘nmtools::array::decorator_t<nmtools::array::slice_t, int [9], nmtools::utl::array<nmtools::utl::array<long unsigned int, 2>, 1> >& nmtools::array::decorator_t<nmtools::array::slice_t, int [9], nmtools::utl::array<nmtools::utl::array<long unsigned int, 2>, 1> >::operator=(const nmtools::array::decorator_t<nmtools::array::slice_t, int [9], nmtools::utl::array<nmtools::utl::array<long unsigned int, 2>, 1> >&)’
  172 |             buffer_[size_] = t;
*/
#ifndef NMTOOLS_DISABLE_STL
TEST_CASE("split(case1)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case1, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case1, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case1, a_ls_db, indices_or_sections, axis );
    #endif
}
#endif

TEST_CASE("split(case2)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case2, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case2, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case2, a_ls_db, indices_or_sections, axis );

    #endif
}

TEST_CASE("split(case3)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case3, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case3, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case3, a_ls_db, indices_or_sections, axis );
    #endif
}

TEST_CASE("split(case4)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case4, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case4, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case4, a_ls_db, indices_or_sections, axis );

    #endif
}

TEST_CASE("split(case5)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case5, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case5, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case5, a_ls_db, indices_or_sections, axis );
    #endif
}

TEST_CASE("split(case6)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case6, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case6, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case6, a_ls_db, indices_or_sections, axis );

    #endif
}

#ifndef NMTOOLS_DISABLE_STL
TEST_CASE("split(case7)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case7, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case7, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case7, a_ls_db, indices_or_sections, axis );

    #endif
}

TEST_CASE("split(case8)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case8, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case8, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case8, a_ls_db, indices_or_sections, axis );
...
// TODO: fix runtime
TEST_CASE("split(case9)" * doctest::test_suite("array::split") * doctest::skip(true))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case9, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case9, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case9, a_ls_db, indices_or_sections, axis );

    #endif
}

TEST_CASE("split(case10)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case10, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case10, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case10, a_ls_db, indices_or_sections, axis );

    #endif
}

#ifndef NMTOOLS_DISABLE_STL
TEST_CASE("split(case11)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case11, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case11, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case11, a_ls_db, indices_or_sections, axis );

    #endif
}
#endif // NMTOOLS_DISABLE_STL

TEST_CASE("split(case12)" * doctest::test_suite("array::split"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    ...
    SPLIT_SUBCASE( case12, a_ls_fb, indices_or_sections, axis );
    SPLIT_SUBCASE( case12, a_ls_hb, indices_or_sections, axis );
    SPLIT_SUBCASE( case12, a_ls_db, indices_or_sections, axis );
