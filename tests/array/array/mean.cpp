...
TEST_CASE("mean(case7)" * doctest::test_suite("array::mean"))
{
    ...
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    {
        ...
        auto rptr = nmtools::get_if<left_t>(&result);
        CHECK( rptr );
...
TEST_CASE("mean(case30)" * doctest::test_suite("array::mean"))
{
    auto dtype = nm::None;
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("mean(case31)" * doctest::test_suite("array::mean"))
{
    auto dtype = nm::None;
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("mean(case32)" * doctest::test_suite("array::mean"))
{
    auto dtype = nm::None;
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
