...
{ \
    ...
    auto result = nmtools::array::cosine_similarity(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("cosine_similarity(case1a)" * doctest::test_suite("array::cosine_similarity"))
{
...
TEST_CASE("cosine_similarity(case1b)" * doctest::test_suite("array::cosine_similarity"))
{
...
TEST_CASE("cosine_similarity(case1c)" * doctest::test_suite("array::cosine_similarity"))
{
...
TEST_CASE("cosine_similarity(case2a)" * doctest::test_suite("array::cosine_similarity"))
{
...
TEST_CASE("cosine_similarity(case2b)" * doctest::test_suite("array::cosine_similarity"))
{
...
TEST_CASE("cosine_similarity(case2c)" * doctest::test_suite("array::cosine_similarity"))
{
...
TEST_CASE("cosine_similarity(case2d)" * doctest::test_suite("array::cosine_similarity"))
{
