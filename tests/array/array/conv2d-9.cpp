...
TEST_CASE("conv2d(case9)" * doctest::test_suite("array::conv2dv2"))
{
    ...
    CONV2D_SUBCASE( case9, input_h, weight_h, bias, stride, padding );
    CONV2D_SUBCASE( case9, input_d, weight_d, bias, stride, padding );
    #else
    CONV2D_SUBCASE( case9, input_cs_fb, weight_cs_fb, bias, stride, padding );
    ...
    CONV2D_SUBCASE( case9, input_fs_fb, weight_fs_fb, bias, stride, padding );
    ...
    CONV2D_SUBCASE( case9, input_ds_fb, weight_ds_fb, bias, stride, padding );
    ...
    CONV2D_SUBCASE( case9, input_ls_fb, weight_ls_fb, bias, stride, padding );
