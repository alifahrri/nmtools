...
TEST_CASE("vector_norm(case2a)" * doctest::test_suite("array::vector_norm"))
{
...
TEST_CASE("vector_norm(case2b)" * doctest::test_suite("array::vector_norm"))
{
...
TEST_CASE("vector_norm(case2c)" * doctest::test_suite("array::vector_norm"))
{
