...
{ \
    ...
    auto result = nmtools::array::deg2rad(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("deg2rad(case1)" * doctest::test_suite("array::deg2rad"))
{
...
TEST_CASE("deg2rad(case2)" * doctest::test_suite("array::deg2rad"))
{
