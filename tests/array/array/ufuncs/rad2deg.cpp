...
{ \
    ...
    auto result = nmtools::array::rad2deg(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("rad2deg(case1)" * doctest::test_suite("array::rad2deg"))
{
...
TEST_CASE("rad2deg(case2)" * doctest::test_suite("array::rad2deg"))
{
