...
{ \
    ...
    auto result = nmtools::array::divide(__VA_ARGS__); \
...
TEST_CASE("divide(case3)" * doctest::test_suite("array::divide"))
{
    DIVIDE_SUBCASE( case3,   a, b );
    DIVIDE_SUBCASE( case3, a_a, b );
    DIVIDE_SUBCASE( case3, a_f, b );
    DIVIDE_SUBCASE( case3, a_d, b );
    DIVIDE_SUBCASE( case3, a_h, b );
}