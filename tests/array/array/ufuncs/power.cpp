...
{ \
    ...
    auto result = nmtools::array::power(__VA_ARGS__); \
...
{ \
    ...
    using namespace args; \
    auto result = nmtools::array::reduce_power( __VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( ::nm::shape(result), expect::shape ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}
...
TEST_CASE("reduce_power(case4)" * doctest::test_suite("array::reduce_power"))
{
    ...
    REDUCE_POWER_SUBCASE( case4, a_d, axis, dtype, initial );
}
...
TEST_CASE("reduce_power(case5)" * doctest::test_suite("array::reduce_power"))
{
    ...
    REDUCE_POWER_SUBCASE( case5, a_d, axis, dtype, initial );
}
...
TEST_CASE("reduce_power(case6)" * doctest::test_suite("array::reduce_power"))
{
    ...
    REDUCE_POWER_SUBCASE( case6, a_d, axis, dtype, initial, keepdims );
}
...
TEST_CASE("reduce_power(case7)" * doctest::test_suite("array::reduce_power"))
{
    ...
    REDUCE_POWER_SUBCASE( case7, a_d, axis, dtype, initial, keepdims );
}
...
TEST_CASE("reduce_power(case8)" * doctest::test_suite("array::reduce_power"))
{
    ...
    REDUCE_POWER_SUBCASE( case8, a_d, axis, dtype, initial, keepdims );
}
...
TEST_CASE("reduce_power(case9)" * doctest::test_suite("array::reduce_power"))
{
    ...
    REDUCE_POWER_SUBCASE( case9, a_d, axis, dtype, initial, keepdims );
}
...
{ \
    ...
    using namespace args; \
    auto result = nmtools::array::accumulate_power(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( ::nm::shape(result), expect::shape ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}
...
{ \
    ...
    using namespace args; \
    auto result = nmtools::array::outer_power(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( ::nm::shape(result), expect::shape ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}
