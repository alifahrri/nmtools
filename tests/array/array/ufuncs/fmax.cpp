...
TEST_CASE("fmax(case2)" * doctest::test_suite("array::fmax"))
{
...
nmtools::fmax.reduce(__VA_ARGS__);
...
nmtools::fmax.accumulate(__VA_ARGS__);
...
nmtools::fmax.outer(__VA_ARGS__);
