...
// TODO: check / improve precision
TEST_CASE("conv1d(case5)" * doctest::test_suite("array::conv1d") * doctest::may_fail())
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    CONV1D_SUBCASE( case5, input, weight );
    CONV1D_SUBCASE( case5, input_a, weight_a );
    CONV1D_SUBCASE( case5, input_f, weight_f );
    CONV1D_SUBCASE( case5, input_h, weight_h );
    CONV1D_SUBCASE( case5, input_d, weight_d );
    #else
    CONV1D_SUBCASE( case5, input_cs_fb, weight_cs_fb );
    CONV1D_SUBCASE( case5, input_cs_hb, weight_cs_hb );
    CONV1D_SUBCASE( case5, input_cs_db, weight_cs_db );

    CONV1D_SUBCASE( case5, input_fs_fb, weight_fs_fb );
    CONV1D_SUBCASE( case5, input_fs_hb, weight_fs_hb );
    CONV1D_SUBCASE( case5, input_fs_db, weight_fs_db );

    CONV1D_SUBCASE( case5, input_hs_fb, weight_hs_fb );
    CONV1D_SUBCASE( case5, input_hs_hb, weight_hs_hb );
    CONV1D_SUBCASE( case5, input_hs_db, weight_hs_db );

    CONV1D_SUBCASE( case5, input_ds_fb, weight_ds_fb );
    CONV1D_SUBCASE( case5, input_ds_hb, weight_ds_hb );
    CONV1D_SUBCASE( case5, input_ds_db, weight_ds_db );

    CONV1D_SUBCASE( case5, input_ls_fb, weight_ls_fb );
    CONV1D_SUBCASE( case5, input_ls_hb, weight_ls_hb );
    CONV1D_SUBCASE( case5, input_ls_db, weight_ls_db );
    #endif
}