...
{ \
    ...
    auto result = nmtools::array::diagonal(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("diagonal(case1)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case2)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case3)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case4)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case5)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case6)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case7)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case8)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case9)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case10)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case11)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case12)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case13)" * doctest::test_suite("array::diagonal"))
{
...
TEST_CASE("diagonal(case14)" * doctest::test_suite("array::diagonal"))
{
