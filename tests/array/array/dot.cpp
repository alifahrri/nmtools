...
{ \
    ...
    auto result = nmtools::array::dot(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("dot(case1)" * doctest::test_suite("array::dot"))
{
...
TEST_CASE("dot(case2)" * doctest::test_suite("array::dot"))
{
...
TEST_CASE("dot(case2b)" * doctest::test_suite("array::dot"))
{
...
TEST_CASE("dot(case2c)" * doctest::test_suite("array::dot"))
{
...
TEST_CASE("dot(case2d)" * doctest::test_suite("array::dot"))
{
...
TEST_CASE("dot(case3)" * doctest::test_suite("array::dot"))
{
...
TEST_CASE("dot(case3b)" * doctest::test_suite("array::dot"))
{
...
TEST_CASE("dot(case3c)" * doctest::test_suite("array::dot"))
{
...
TEST_CASE("dot(case3d)" * doctest::test_suite("array::dot"))
{
