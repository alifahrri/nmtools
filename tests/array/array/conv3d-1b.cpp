...
TEST_CASE("conv3d(case1b)" * doctest::test_suite("array::conv3d"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    CONV3D_SUBCASE( case1b, input, weight, bias );
    CONV3D_SUBCASE( case1b, input_a, weight_a, bias_a );
    CONV3D_SUBCASE( case1b, input_f, weight_f, bias_f );
    CONV3D_SUBCASE( case1b, input_h, weight_h, bias_h );
    CONV3D_SUBCASE( case1b, input_d, weight_d, bias_d );
    #else
    #endif
}