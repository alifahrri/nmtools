...
{
    {
        ...
        // TODO: deduce as fixed buffer
        using expected_t = na::ndarray_t<nmtools_list<int>,nmtools_tuple<meta::ct<1ul>>>;
    ...
    }
    {
        ...
        using eval_t = meta::resolve_optype_t<na::eval_result_t, view_t, none_t>;
        using expected_t = na::ndarray_t<nmtools_array<int,3>,nmtools_array<size_t,1>>;
        NMTOOLS_STATIC_CHECK_IS_SAME( eval_t, expected_t );
    }
    {
    ...
    // constant-shape, dynamic-buffer
    {
        ...
        using eval_t     = meta::resolve_optype_t<na::eval_result_t, view_t, none_t>;
        using expected_t = na::ndarray_t<nmtools_array<float,3>,decltype(nmtools_tuple{2_ct,3_ct,2_ct})>;
        NMTOOLS_STATIC_CHECK_IS_SAME( eval_t, expected_t );
    }
