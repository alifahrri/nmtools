...
#if 1
TEST_CASE("accumulate(case1)" * doctest::test_suite("meta::accumulate"))
{
    {
        ...
        using view_type = decltype(view::accumulate_add(declval(array_type),declval(axis_type)));
...
TEST_CASE("accumulate(case2)" * doctest::test_suite("meta::accumulate"))
{
    {
        using buffer_type = nmtools_array<float,12>;
        using shape_type  = nmtools_array<size_t,3>;
...
// TODO: fix
TEST_CASE("accumulate(case3)" * doctest::test_suite("meta::accumulate") * doctest::may_fail())
{
    {
        using array_type = float[2][3][2];
