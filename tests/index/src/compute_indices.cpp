...
#define COMPUTE_INDICES_RESULT_SUBCASE(case_name, result, ...) \
SUBCASE(#case_name) \
{ \
    NMTOOLS_TESTING_USE_CASE(compute_indices, case_name); \
    using namespace args; \
    auto indices = nmtools::index::compute_indices(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL_MSG_ATTRIBUTES( indices, expect::result, __VA_ARGS__ ); \
}

TEST_CASE("compute_indices(case1_2d)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case1_2d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case1_2d, result_nl2, offset, shape_nl2);

    COMPUTE_INDICES_SUBCASE(case1_2d, offset, shape_mx1);
    COMPUTE_INDICES_SUBCASE(case1_2d, offset, shape_mx2);
}
...
TEST_CASE("compute_indices(case1)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case1_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case1_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case1_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case2)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case2_2d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case2_2d, result_nl2, offset, shape_nl2);
...
TEST_CASE("compute_indices(case2)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case2_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case2_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case2_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case3)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case3_2d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case3_2d, result_nl2, offset, shape_nl2);
...
TEST_CASE("compute_indices(case3)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case3_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case3_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case3_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case4)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case4_2d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case4_2d, result_nl2, offset, shape_nl2);
...
TEST_CASE("compute_indices(case4)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case4_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case4_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case4_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case5)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case5_2d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case5_2d, result_nl2, offset, shape_nl2);
...
TEST_CASE("compute_indices(case5)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case5_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case5_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case5_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case6)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case6_2d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case6_2d, result_nl2, offset, shape_nl2);
...
TEST_CASE("compute_indices(case6)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case6_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case6_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case6_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case8)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case8_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case8_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case8_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case9)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case9_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case9_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case9_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case10)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case10_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case10_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case10_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case11)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case11_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case11_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case11_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case12)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case12_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case12_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case12_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case13)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case13_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case13_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case13_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case14)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case14_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case14_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case14_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case15)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case15_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case15_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case15_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case16)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case16_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case16_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case16_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case17)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case17_3d, result_nl1, offset, shape_nl1);
    COMPUTE_INDICES_RESULT_SUBCASE(case17_3d, result_nl2, offset, shape_nl2);
    COMPUTE_INDICES_RESULT_SUBCASE(case17_3d, result_nl3, offset, shape_nl3);
...
TEST_CASE("compute_indices(case18)" * doctest::test_suite("index::compute_indices"))
{
    ...
    COMPUTE_INDICES_RESULT_SUBCASE(case18_3d, result_nl1, offset, shape_nl1);
