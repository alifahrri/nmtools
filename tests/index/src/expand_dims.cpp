...
#if 0
TEST_CASE("shape_expand_dims(vector)" * doctest::test_suite("index::shape_expand_dims"))
{
    {
        auto shape = nmtools_list{1,2,3};
        auto axes  = nmtools_array{0};
        auto newshape = nm::index::shape_expand_dims(shape,axes);
    ...
    }
    {
        ...
        auto newshape = nm::index::shape_expand_dims(shape,axes);
        // on numpy 1.18
        // >>> np.shape_expand_dims(np.random.rand(1,2,3),(1,2)).shape
        // (1, 1, 1, 2, 3)
        auto expected = nmtools_list{1,1,1,2,3};
        NMTOOLS_ASSERT_EQUAL( newshape, expected );
    }
...
TEST_CASE("shape_expand_dims(array)" * doctest::test_suite("index::shape_expand_dims"))
{
    {
...
#if 0
TEST_CASE("shape_expand_dims(tuple)" * doctest::test_suite("index::shape_expand_dims"))
{
    {
