...
TEST_CASE("add.outer_2d(case1a)" * doctest::test_suite("simd::x86_AVX"))
{
    auto M = 2;
    auto N = 4;
    auto K = 5;
...
#if 0
TEST_CASE("add.outer_2d(case13a)" * doctest::test_suite("simd::x86_AVX"))
{
    auto dtype = nm::int8;
    auto M = 2;
    auto N = 4;
...
TEST_CASE("add.outer_2d(case16a)" * doctest::test_suite("simd::x86_AVX"))
{
    auto M = 2;
    auto N = 4;
    auto O = 5;
