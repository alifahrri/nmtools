...
TEST_CASE("broadcast_add(case1)" * doctest::test_suite("simd::x86_AVX"))
{
...
TEST_CASE("broadcast_add(case2)" * doctest::test_suite("simd::x86_AVX"))
{
    auto n_item = 32;
...
TEST_CASE("broadcast_add(case3)" * doctest::test_suite("simd::x86_AVX"))
{
    auto n_item = 32;
    auto lhs_a = na::arange(n_item);
    auto rhs_a = na::arange(n_item);
...
TEST_CASE("broadcast_add(case4)" * doctest::test_suite("simd::x86_AVX"))
{
    auto n_item = 12;
    auto lhs_a = na::arange(n_item);
    auto rhs_a = na::arange(n_item);
...
TEST_CASE("broadcast_add(case5)" * doctest::test_suite("simd::x86_AVX"))
{
    auto n_item = 12;
    auto lhs_a = na::arange(n_item);
    auto rhs_a = na::arange(n_item);
...
TEST_CASE("broadcast_add(case6)" * doctest::test_suite("simd::x86_AVX"))
{
    auto n_item = 5;
    auto lhs_a = na::arange(n_item);
    auto rhs_a = na::arange(n_item);
...
TEST_CASE("broadcast_add(case7)" * doctest::test_suite("simd::x86_AVX"))
{
    auto n_item = 5;
    auto lhs_a = na::arange(n_item);
    auto rhs_a = na::arange(n_item);
...
TEST_CASE("broadcast_add(case8)" * doctest::test_suite("simd::x86_AVX"))
{
    auto n_item = 9;
    auto lhs_a = na::arange(n_item);
    auto rhs_a = na::arange(n_item);
...
TEST_CASE("broadcast_add(case9)" * doctest::test_suite("simd::x86_AVX"))
{
    auto n_item = 9;
    auto lhs_a = na::arange(n_item);
    auto rhs_a = na::arange(n_item);
