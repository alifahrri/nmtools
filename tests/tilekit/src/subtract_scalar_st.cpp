...
#define SCALAR_ST_SUBTRACT_CASE(case_name, shape, tile_shape) \
...
SCALAR_ST_SUBTRACT_CASE(scalar_st.subtract.1024_1024.fp32.2x4, (make_shape(1024,1024)), (tuple{2_ct,4_ct}))