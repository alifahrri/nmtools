...
#define SCALAR_MATMUL_CASE( case_name, M, K, N, mkn_tile ) \
...
// SCALAR_MATMUL_CASE( scalar_st.matmul.2_8_2.fp32.2x2x2, 2, 8, 2, (tuple{2_ct,2_ct,2_ct}) );
SCALAR_MATMUL_CASE( scalar_st.matmul.4_16_4.fp32.2x2x2, 4, 16, 4, (tuple{2_ct,2_ct,2_ct}) );
// SCALAR_MATMUL_CASE( scalar_st.matmul.8_32_8.fp32.2x2x2, 8, 32, 8, (tuple{2_ct,2_ct,2_ct}) );

SCALAR_MATMUL_CASE( scalar_st.matmul.4_16_4.fp32.4x2x2, 4, 16, 4, (tuple{4_ct,2_ct,2_ct}) );
// SCALAR_MATMUL_CASE( scalar_st.matmul.8_32_8.fp32.4x2x2, 8, 32, 8, (tuple{4_ct,2_ct,2_ct}) );

SCALAR_MATMUL_CASE( scalar_st.matmul.4_16_4.fp32.2x4x2, 4, 16, 4, (tuple{2_ct,4_ct,2_ct}) );
// SCALAR_MATMUL_CASE( scalar_st.matmul.8_32_8.fp32.2x4x2, 8, 32, 8, (tuple{2_ct,4_ct,2_ct}) );

SCALAR_MATMUL_CASE( scalar_st.matmul.4_16_4.fp32.2x2x4, 4, 16, 4, (tuple{2_ct,2_ct,4_ct}) );
// SCALAR_MATMUL_CASE( scalar_st.matmul.8_32_8.fp32.2x2x4, 8, 32, 8, (tuple{2_ct,2_ct,4_ct}) );

SCALAR_MATMUL_CASE( scalar_st.matmul.4_16_4.fp32.4x2x4, 4, 16, 4, (tuple{4_ct,2_ct,4_ct}) );
// SCALAR_MATMUL_CASE( scalar_st.matmul.8_32_8.fp32.4x2x4, 8, 32, 8, (tuple{4_ct,2_ct,4_ct}) );