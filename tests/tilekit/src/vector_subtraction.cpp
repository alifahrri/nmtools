#include "kernels/vector_subtract.hpp"
...
TEST_CASE("vector_subtract_kernel(f32x4)" * doctest::test_suite("tilekit"))
{
    ...
    ankerl::nanobench::Bench()
        ...
        .run("vector_subtract_kernel(f32x4)",[&](){
            vector_subtract(ctx,c,a,b);
        });
...
TEST_CASE("vector_subtract(f32x4)" * doctest::test_suite("tilekit"))
{
    auto gen = nm::random_engine();
    auto dtype = nm::float32;
...
TEST_CASE("vector_subtract_kernel(i32x4)" * doctest::test_suite("tilekit"))
{
    auto gen = nm::random_engine();
    auto dtype = nm::int32;
    ...
    ankerl::nanobench::Bench()
        .minEpochTime(min_time)
        .run("vector_subtract_kernel(i32x4)",[&](){
            vector_subtract(ctx,c,a,b);
        });
...
TEST_CASE("vector_subtract(i32x4)" * doctest::test_suite("tilekit"))
{
    auto gen = nm::random_engine();
    auto dtype = nm::int32;
