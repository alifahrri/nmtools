...
#define SCALAR_ST_MULTIPLY_CASE(case_name, shape, tile_shape) \
...
SCALAR_ST_MULTIPLY_CASE(scalar_st.multiply.1024_1024.fp32.2x4, (make_shape(1024,1024)), (tuple{2_ct,4_ct}))