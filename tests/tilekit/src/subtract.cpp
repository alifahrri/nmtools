...
TEST_CASE("subtract.case1" * doctest::test_suite("tilekit"))
{
...
TEST_CASE("subtract.case2" * doctest::test_suite("tilekit"))
{
    auto gen   = nm::random_engine();
    auto dtype = nm::float32;
...
TEST_CASE("subtract.case3" * doctest::test_suite("tilekit"))
{
    auto gen   = nm::random_engine();
    auto dtype = nm::float32;
