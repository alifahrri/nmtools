#ifndef NMTOOLS_TESTS_KERNELS_VECTOR_MULTIPLY_HPP
#define NMTOOLS_TESTS_KERNELS_VECTOR_MULTIPLY_HPP
...
auto vector_multiply(context_t& ctx, out_t& out, const a_t& a, const b_t& b)
{
...
#endif // NMTOOLS_TESTS_KERNELS_VECTOR_MULTIPLY_HPP