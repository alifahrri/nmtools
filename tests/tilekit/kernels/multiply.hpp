#ifndef NMTOOLS_TESTS_KERNELS_MULTIPLY_HPP
#define NMTOOLS_TESTS_KERNELS_MULTIPLY_HPP
...
struct multiply_kernel_t
{
    ...
    {
        nmtools_tracy_zone_scoped("Multiply Kernel");
...
inline auto multiply_kernel = multiply_kernel_t<0>{};
inline auto multiply_padding_kernel = multiply_kernel_t<1>{};

#endif // NMTOOLS_TESTS_KERNELS_MULTIPLY_HPP