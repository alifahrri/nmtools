#ifndef NMTOOLS_TESTS_TILEKIT_KERNELS_MAX_HPP
#define NMTOOLS_TESTS_TILEKIT_KERNELS_MAX_HPP
...
struct max_kernel_t
{
    ...
    {
        nmtools_tracy_zone_scoped("max kernel");
        ...
        for (nm_size_t i=(w_id*w_size); i<(axis_0_iter/w_size); i++) {
            ...
            auto result = accumulator.max(axis);
...
constexpr inline auto max_kernel = max_kernel_t {};

#endif // NMTOOLS_TESTS_TILEKIT_KERNELS_MAX_HPP