#ifndef NMTOOLS_TESTS_KERNELS_STD_HPP
#define NMTOOLS_TESTS_KERNELS_STD_HPP
...
struct std_kernel_t
{
    ...
    {
        nmtools_tracy_zone_scoped("std kernel");
        ...
        for (nm_size_t i=(w_id); i<(axis_0_iter); i+=w_size) {
            ...
            auto result = (sum_sq_sub / num_elements.broadcast_to(sum_sq_sub.shape())).sqrt();
...
constexpr inline auto std_kernel = std_kernel_t {};

#endif // NMTOOLS_TESTS_KERNELS_STD_HPP