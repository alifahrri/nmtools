...
struct minimum_kernel_t
{
    ...
    {
        nmtools_tracy_zone_scoped("minimum kernel");
        ...
        for (nm_size_t i=0; i<n_iter; i++) {
            ...
            auto result  = block_a.minimum(block_b);
...
inline auto minimum_kernel = minimum_kernel_t<0>{};
inline auto minimum_padding_kernel = minimum_kernel_t<1>{};
