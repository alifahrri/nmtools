#ifndef NMTOOLS_TESTS_KERNELS_SQRT_HPP
#define NMTOOLS_TESTS_KERNELS_SQRT_HPP
...
struct sqrt_kernel_t
{
    ...
    {
        nmtools_tracy_zone_scoped("sqrt kernel");
...
constexpr inline auto sqrt_kernel = sqrt_kernel_t{};
constexpr inline auto sqrt_utl_kernel = sqrt_kernel_t<true>{};

#endif // NMTOOLS_TESTS_KERNELS_SQRT_HPP