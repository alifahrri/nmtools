...
TEST_CASE("edge_contraction(case1)" * doctest::test_suite("ct_digraph"))
{
    auto array = nmtools_array{1,2,3,4};
    ...
    NMTOOLS_ASSERT_EQUAL( utility::contains(graph.nodes(),from), 1 );
    NMTOOLS_ASSERT_EQUAL( utility::contains(graph.nodes(),to), 1);

    auto merged_node = utility::graph_data_merger(graph.nodes(from),graph.nodes(to));
    static_assert( meta::len_v<decltype(merged_node)> == 2 );

    [[maybe_unused]]
    auto expected = utility::ct_digraph()
        .add_node(0_ct,&array)
        .add_node(2_ct,nmtools_tuple{fn::relu,fn::tanh})
        .add_edge(0_ct,2_ct)
    ;

    [[maybe_unused]]
    auto result = graph.contract_edge(1_ct,2_ct);

    NMTOOLS_ASSERT_EQUAL( result.size(), expected.size() );
    NMTOOLS_STATIC_CHECK_IS_SAME(
        meta::remove_cvref_t<decltype(result.nodes(2_ct))>
        , meta::remove_cvref_t<decltype(expected.nodes(2_ct))>
    );
}

TEST_CASE("edge_contraction(case2)" * doctest::test_suite("ct_digraph"))
{
    auto array = nmtools_array{1,2,3,4};
    ...
    auto graph = utility::ct_digraph()
        ...
        .add_node(1_ct,fn::relu)
        .add_node(2_ct,fn::tanh)
        .add_node(3_ct,nm::None)
        .add_node(4_ct,nm::None)
        .add_edge(0_ct,1_ct)
        .add_edge(1_ct,2_ct)
        .add_edge(1_ct,3_ct)
        .add_edge(3_ct,4_ct)
    ...
    NMTOOLS_STATIC_CHECK_IS_SAME(
        meta::remove_cvref_t<decltype(result.nodes(3_ct))>
        , meta::remove_cvref_t<decltype(expected.nodes(3_ct))>
    );
    NMTOOLS_STATIC_CHECK_IS_SAME(
        meta::remove_cvref_t<decltype(result.nodes(4_ct))>
        , meta::remove_cvref_t<decltype(expected.nodes(4_ct))>
    );

    NMTOOLS_STATIC_CHECK_IS_SAME(
        meta::remove_cvref_t<decltype(result.out_edges(2_ct))>
        , meta::remove_cvref_t<decltype(expected.out_edges(2_ct))>
    );
    NMTOOLS_STATIC_CHECK_IS_SAME(
        meta::remove_cvref_t<decltype(result.out_edges(3_ct))>
        , meta::remove_cvref_t<decltype(expected.out_edges(3_ct))>
    );
    NMTOOLS_STATIC_CHECK_IS_SAME(
        meta::remove_cvref_t<decltype(result.out_edges(4_ct))>
        , meta::remove_cvref_t<decltype(expected.out_edges(4_ct))>
    );
}

TEST_CASE("edge_contraction(case3)" * doctest::test_suite("ct_digraph"))
{
    auto array = nmtools_array{1,2,3,4};
    ...
    auto result = graph.contract_edge(1_ct,3_ct);

    auto expected = utility::ct_digraph()
        .add_node(0_ct,&array)
        .add_node(3_ct,nmtools_tuple{fn::relu,nm::None})
        .add_node(2_ct,fn::tanh)
        .add_node(4_ct,nm::None)
        .add_edge(0_ct,3_ct)
        .add_edge(3_ct,2_ct)
...
TEST_CASE("edge_contraction(case4)" * doctest::test_suite("ct_digraph"))
{
    auto array = nmtools_array{1,2,3,4};
    ...
    auto graph = utility::ct_digraph()
        ...
        .add_node(3_ct,nm::None)
        .add_node(4_ct,nm::None)
        .add_edges(0_ct,nmtools_tuple{1_ct})
        .add_edges(1_ct,nmtools_tuple{2_ct,3_ct})
        .add_edges(2_ct,nmtools_tuple{4_ct})
        .add_edges(3_ct,nmtools_tuple{4_ct})
    ;
    ...
    auto expected = utility::ct_digraph()
        ...
        .add_node(3_ct,nm::None)
        .add_node(4_ct,nm::None)
        .add_edges(0_ct,nmtools_tuple{2_ct})
        .add_edges(2_ct,nmtools_tuple{3_ct,4_ct})
        .add_edges(3_ct,nmtools_tuple{4_ct})
    ;
...
TEST_CASE("edge_contraction(case5)" * doctest::test_suite("ct_digraph"))
{
    auto array = nmtools_array{1,2,3,4};
    ...
    auto result = graph.contract_edge(2_ct,4_ct);

    auto expected = utility::ct_digraph()
        .add_node(0_ct,&array)
        .add_node(1_ct,fn::relu)
        .add_node(4_ct,nmtools_tuple{fn::tanh,nm::None})
        .add_node(3_ct,nm::None)
        .add_edges(0_ct,nmtools_tuple{1_ct})
        .add_edges(1_ct,nmtools_tuple{4_ct,3_ct})
        .add_edges(3_ct,nmtools_tuple{4_ct})
    ;
