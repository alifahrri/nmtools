...
{ \
    ...
    auto result = na::transpose(__VA_ARGS__, cuda::default_context()); \
...
// TODO: fix test case
TEST_CASE("transpose(case3)" * doctest::test_suite("array::transpose") * doctest::may_fail())
{
...
// TODO: fix test case
TEST_CASE("transpose(case7)" * doctest::test_suite("array::transpose") * doctest::may_fail())
{
...
TEST_CASE("transpose(case9)" * doctest::test_suite("array::transpose") * doctest::skip())
{
