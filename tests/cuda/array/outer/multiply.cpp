...
{ \
    ...
    auto result = na::multiply.outer(__VA_ARGS__, cuda::default_context()); \
...
TEST_CASE("outer_multiply(case1)" * doctest::test_suite("array::multiply.outer"))
{
    ...
    OUTER_MULTIPLY_SUBCASE(case1, a_fs_fb, b_fs_fb);
    OUTER_MULTIPLY_SUBCASE(case1, a_fs_hb, b_fs_hb);
    OUTER_MULTIPLY_SUBCASE(case1, a_fs_db, b_fs_db);

    OUTER_MULTIPLY_SUBCASE(case1, a_hs_fb, b_hs_fb);
    OUTER_MULTIPLY_SUBCASE(case1, a_hs_hb, b_hs_hb);
    OUTER_MULTIPLY_SUBCASE(case1, a_hs_db, b_hs_db);

    OUTER_MULTIPLY_SUBCASE(case1, a_ds_fb, b_ds_fb);
    OUTER_MULTIPLY_SUBCASE(case1, a_ds_hb, b_ds_hb);
