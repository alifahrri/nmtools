#ifndef NMTOOLS_TESTING_DATA_BLAS_ROW_SUM_HPP
#define NMTOOLS_TESTING_DATA_BLAS_ROW_SUM_HPP
...
NMTOOLS_TESTING_DECLARE_CASE(blas,row_sum)
{
    ...
    NMTOOLS_TESTING_DECLARE_EXPECT(case1) {
        inline constexpr auto sum = std::array<double,5>{7, 9, 11, 13, 15};
    }
...
} // namespace nmtools::testing::data::blas::row_sum

#endif // NMTOOLS_TESTING_DATA_BLAS_ROW_SUM_HPP