...
#if 1
TEST_CASE("transform_unary_fusion(cosine_similarity)" * doctest::test_suite("transform"))
{
    ...
    auto res = view::cosine_similarity(lhs,rhs,axis);
...
#if 1
TEST_CASE("transform_binary_fusion(cosine_similarity1)" * doctest::test_suite("transform"))
{
    auto gen = na::random_engine();
    auto dtype = nm::float32;
...
#if 1
TEST_CASE("transform_binary_fusion(cosine_similarity2)" * doctest::test_suite("transform"))
{
    auto gen = na::random_engine();
    auto dtype = nm::float32;
...
#if 1
TEST_CASE("transform_binary_fusion(cosine_similarity3)" * doctest::test_suite("transform"))
{
    auto gen = na::random_engine();
    auto dtype = nm::float32;
...
#if 1
TEST_CASE("transform_binary_fusion(cosine_similarity4)" * doctest::test_suite("transform"))
{
    auto gen = na::random_engine();
    auto dtype = nm::float32;
...
#if 1
TEST_CASE("transform_binary_fusion(cosine_similarity5)" * doctest::test_suite("transform"))
{
    auto gen = na::random_engine();
    auto dtype = nm::float32;
...
#if 1
TEST_CASE("linearize(cosine_similarity)" * doctest::test_suite("transform"))
{
    auto gen = na::random_engine();
    auto dtype = nm::float32;
