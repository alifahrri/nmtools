...
{ \
    ...
    auto result = nmtools::view::stack(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nm::shape(result), nm::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("stack(case1)" * doctest::test_suite("view::stack"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("stack(case2)" * doctest::test_suite("view::stack"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("stack(case3)" * doctest::test_suite("view::stack"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("stack(case4)" * doctest::test_suite("view::stack"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("stack(case5)" * doctest::test_suite("view::stack"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
