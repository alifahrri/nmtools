...
TEST_CASE("max_pool2d(case19)" * doctest::test_suite("view::max_pool2d"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("max_pool2d(case20)" * doctest::test_suite("view::max_pool2d"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("max_pool2d(case21)" * doctest::test_suite("view::max_pool2d"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("max_pool2d(case22)" * doctest::test_suite("view::max_pool2d"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
