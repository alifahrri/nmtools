...
{ \
    ...
    auto result = nmtools::view::bilinear(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("bilinear(case1a)" * doctest::test_suite("view::bilinear"))
{
...
TEST_CASE("bilinear(case1b)" * doctest::test_suite("view::bilinear"))
{
...
TEST_CASE("bilinear(case2a)" * doctest::test_suite("view::bilinear"))
{
...
TEST_CASE("bilinear(case2c)" * doctest::test_suite("view::bilinear"))
{
...
TEST_CASE("bilinear(case3a)" * doctest::test_suite("view::bilinear"))
{
...
TEST_CASE("bilinear(case3b)" * doctest::test_suite("view::bilinear"))
{
...
TEST_CASE("bilinear(case3c)" * doctest::test_suite("view::bilinear"))
{
...
TEST_CASE("bilinear(case3d)" * doctest::test_suite("view::bilinear"))
{
...
TEST_CASE("bilinear(case4a)" * doctest::test_suite("view::bilinear"))
{
