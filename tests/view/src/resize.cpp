...
TEST_CASE("resize(case1)" * doctest::test_suite("view::resize"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("resize(case2)" * doctest::test_suite("view::resize"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("resize(case3)" * doctest::test_suite("view::resize"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("resize(case4)" * doctest::test_suite("view::resize"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("resize(case5)" * doctest::test_suite("view::resize"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("resize(case6)" * doctest::test_suite("view::resize"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
