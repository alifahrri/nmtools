...
{ \
    ...
    auto result = nmtools::view::trace(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("trace(case1)" * doctest::test_suite("view::trace"))
{
    SUBCASE("meta")
    {
        NMTOOLS_TESTING_USE_CASE( array, trace, case1 );
        {
            auto result = nmtools::view::trace( a );
...
TEST_CASE("trace(case3)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case4)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case5)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case6)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case7)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case8)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case9)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case10)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case11)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case12)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case13)" * doctest::test_suite("view::trace"))
{
...
TEST_CASE("trace(case14)" * doctest::test_suite("view::trace"))
{
