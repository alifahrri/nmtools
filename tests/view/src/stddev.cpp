...
nmtools::view::stddev(__VA_ARGS__);
...
[](auto&&...args){ \
    auto title = std::string("view::stddev-") + #case_name; \
...
TEST_CASE("stddev(case1)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case2)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case3)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case4)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case5)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case6)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case7)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case8)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case9)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case10)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case11)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case12)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case13)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case14)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case15)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case16)" * doctest::test_suite("view::stddev"))
{
...
TEST_CASE("stddev(case17)" * doctest::test_suite("view::stddev"))
{
