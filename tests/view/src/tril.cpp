...
{ \
    ...
    auto result = nmtools::view::tril(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("tril(case1a)" * doctest::test_suite("view::tril"))
{
...
TEST_CASE("tril(case1b)" * doctest::test_suite("view::tril"))
{
...
TEST_CASE("tril(case1c)" * doctest::test_suite("view::tril"))
{
...
TEST_CASE("tril(case2a)" * doctest::test_suite("view::tril"))
{
...
TEST_CASE("tril(case2b)" * doctest::test_suite("view::tril"))
{
...
TEST_CASE("tril(case2c)" * doctest::test_suite("view::tril"))
{
...
TEST_CASE("tril(case3a)" * doctest::test_suite("view::tril"))
{
...
TEST_CASE("tril(case3b)" * doctest::test_suite("view::tril"))
{
...
TEST_CASE("tril(case3c)" * doctest::test_suite("view::tril"))
{
...
TEST_CASE("tril(case3d)" * doctest::test_suite("view::tril"))
{
