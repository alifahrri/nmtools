...
nmtools::view::atleast_1d(__VA_ARGS__);
...
TEST_CASE("atleast_1d(case1)" * doctest::test_suite("view::atleast_1d"))
{
    ATLEAST_1D_SUBCASE( case1, a );
}

TEST_CASE("atleast_1d(case2)" * doctest::test_suite("view::atleast_1d"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("atleast_1d(case3)" * doctest::test_suite("view::atleast_1d"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("atleast_1d(case4)" * doctest::test_suite("view::atleast_1d"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
...
TEST_CASE("atleast_1d(traits)" * doctest::test_suite("view::atleast_1d"))
{
    SUBCASE("fixed_ndarray(int)")
    {
        int a = 1;
        auto array = view::atleast_1d(a);
