...
{ \
    ...
    auto result = nmtools::view::diagflat(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("diagflat(case1)" * doctest::test_suite("view::diagflat"))
{
...
TEST_CASE("diagflat(case2)" * doctest::test_suite("view::diagflat"))
{
...
TEST_CASE("diagflat(case3)" * doctest::test_suite("view::diagflat"))
{
