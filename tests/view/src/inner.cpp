...
{ \
    ...
    auto result = nmtools::view::inner(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("inner(case1)" * doctest::test_suite("view::inner"))
{
...
TEST_CASE("inner(case1b)" * doctest::test_suite("view::inner"))
{
...
TEST_CASE("inner(case1c)" * doctest::test_suite("view::inner"))
{
...
TEST_CASE("inner(case2)" * doctest::test_suite("view::inner"))
{
...
TEST_CASE("inner(case2b)" * doctest::test_suite("view::inner"))
{
...
TEST_CASE("inner(case2c)" * doctest::test_suite("view::inner"))
{
...
TEST_CASE("inner(case2d)" * doctest::test_suite("view::inner"))
{
...
TEST_CASE("inner(case3)" * doctest::test_suite("view::inner"))
{
...
TEST_CASE("inner(case3b)" * doctest::test_suite("view::inner"))
{
...
TEST_CASE("inner(case3c)" * doctest::test_suite("view::inner"))
{
...
TEST_CASE("inner(case3d)" * doctest::test_suite("view::inner"))
{
