...
{ \
    ...
    auto result = nmtools::view::tiling_window(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::expected) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::expected ); \
}

TEST_CASE("tiling_window(case1)" * doctest::test_suite("view::tiling_window"))
{
...
TEST_CASE("tiling_window(case2)" * doctest::test_suite("view::tiling_window"))
{
    #ifndef NMTOOLS_TESTING_GENERIC_NDARRAY
...
TEST_CASE("tiling_window(case2b)" * doctest::test_suite("view::tiling_window"))
{
    #ifndef NMTOOLS_TESTING_GENERIC_NDARRAY
...
#if 1
TEST_CASE("tiling_window(case2c)" * doctest::test_suite("view::tiling_window"))
{
    #ifndef NMTOOLS_TESTING_GENERIC_NDARRAY
...
#if 1
TEST_CASE("tiling_window(case2d)" * doctest::test_suite("view::tiling_window"))
{
    #ifndef NMTOOLS_TESTING_GENERIC_NDARRAY
...
TEST_CASE("tiling_window(case2e)" * doctest::test_suite("view::tiling_window"))
{
    #ifndef NMTOOLS_TESTING_GENERIC_NDARRAY
...
TEST_CASE("tiling_window(case3a)" * doctest::test_suite("view::tiling_window"))
{
    #ifndef NMTOOLS_TESTING_GENERIC_NDARRAY
...
TEST_CASE("tiling_window(case3b)" * doctest::test_suite("view::tiling_window"))
{
    #ifndef NMTOOLS_TESTING_GENERIC_NDARRAY
...
TEST_CASE("tiling_window(case3c)" * doctest::test_suite("view::tiling_window"))
{
    #ifndef NMTOOLS_TESTING_GENERIC_NDARRAY
...
TEST_CASE("tiling_window(case3d)" * doctest::test_suite("view::tiling_window"))
{
    #ifndef NMTOOLS_TESTING_GENERIC_NDARRAY
