...
{ \
    ...
    auto result = nmtools::view::vecdot(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("vecdot(case1a)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case1b)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case1c)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case1d)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case1e)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case1f)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case2a)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case2b)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case2c)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case2d)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case2e)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case2f)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case3a)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case3b)" * doctest::test_suite("view::vecdot"))
{
...
TEST_CASE("vecdot(case3c)" * doctest::test_suite("view::vecdot"))
{
