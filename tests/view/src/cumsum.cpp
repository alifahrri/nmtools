...
TEST_CASE("cumsum(case1)" * doctest::test_suite("view::cumsum"))
{
...
TEST_CASE("cumsum(case2)" * doctest::test_suite("view::cumsum"))
{
...
TEST_CASE("cumsum(case3)" * doctest::test_suite("view::cumsum"))
{
