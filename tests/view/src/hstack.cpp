...
SUBCASE(#case_name) \
{ \
    NMTOOLS_TESTING_DECLARE_NS( hstack, case_name ) \
    using namespace args; \
    auto result = nmtools::view::hstack(__VA_ARGS__); \
...
TEST_CASE("hstack(case1)" * doctest::test_suite("view::hstack"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    // TODO: fix nostl build
...
TEST_CASE("hstack(case2)" * doctest::test_suite("view::hstack"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    // TODO: fix nostl build
    #ifndef NMTOOLS_DISABLE_STL
...
TEST_CASE("hstack(case3)" * doctest::test_suite("view::hstack"))
{
    #if !defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
    // TODO: fix nostl build
    #ifndef NMTOOLS_DISABLE_STL
...
// TODO: fix
TEST_CASE("hstack(case3)" * doctest::test_suite("view::hstack") * doctest::may_fail())
{
    #if defined(NMTOOLS_TESTING_GENERIC_NDARRAY)
