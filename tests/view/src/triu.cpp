...
{ \
    ...
    auto result = nmtools::view::triu(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("triu(case1a)" * doctest::test_suite("view::triu"))
{
...
TEST_CASE("triu(case1b)" * doctest::test_suite("view::triu"))
{
...
TEST_CASE("triu(case1c)" * doctest::test_suite("view::triu"))
{
...
TEST_CASE("triu(case2a)" * doctest::test_suite("view::triu"))
{
...
TEST_CASE("triu(case2b)" * doctest::test_suite("view::triu"))
{
...
TEST_CASE("triu(case2c)" * doctest::test_suite("view::triu"))
{
...
TEST_CASE("triu(case3a)" * doctest::test_suite("view::triu"))
{
...
TEST_CASE("triu(case3b)" * doctest::test_suite("view::triu"))
{
...
TEST_CASE("triu(case3c)" * doctest::test_suite("view::triu"))
{
...
TEST_CASE("triu(case3d)" * doctest::test_suite("view::triu"))
{
