...
{ \
    ...
    auto result = nmtools::view::linear(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("linear(case1a)" * doctest::test_suite("view::linear"))
{
...
TEST_CASE("linear(case1b)" * doctest::test_suite("view::linear"))
{
...
TEST_CASE("linear(case1c)" * doctest::test_suite("view::linear"))
{
...
TEST_CASE("linear(case2a)" * doctest::test_suite("view::linear"))
{
...
TEST_CASE("linear(case2b)" * doctest::test_suite("view::linear"))
{
...
TEST_CASE("linear(case2c)" * doctest::test_suite("view::linear"))
{
...
TEST_CASE("linear(case3a)" * doctest::test_suite("view::linear"))
{
...
TEST_CASE("linear(case3b)" * doctest::test_suite("view::linear"))
{
...
TEST_CASE("linear(case3c)" * doctest::test_suite("view::linear"))
{
