...
{ \
    ...
    auto result = nmtools::view::ones_like(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("ones_like(case1)" * doctest::test_suite("view::ones_like"))
{
...
TEST_CASE("ones_like(case2)" * doctest::test_suite("view::ones_like"))
{
...
TEST_CASE("ones_like(case3)" * doctest::test_suite("view::ones_like"))
{
