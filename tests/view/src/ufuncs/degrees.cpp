...
{ \
    ...
    auto result = nmtools::view::degrees(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("degrees(case1)" * doctest::test_suite("view::degrees"))
{
...
TEST_CASE("degrees(case2)" * doctest::test_suite("view::degrees"))
{
