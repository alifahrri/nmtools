...
{ \
    ...
    auto result = nmtools::view::column_stack( __VA_ARGS__ ); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("column_stack(case1)" * doctest::test_suite("view::column_stack"))
{
...
TEST_CASE("column_stack(case2)" * doctest::test_suite("view::column_stack"))
{
...
TEST_CASE("column_stack(case3)" * doctest::test_suite("view::column_stack"))
{
