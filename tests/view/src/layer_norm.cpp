...
{ \
    ...
    auto result = nmtools::view::layer_norm(__VA_ARGS__); \
...
TEST_CASE("layer_norm(case1)" * doctest::test_suite("view::layer_norm"))
{
...
TEST_CASE("layer_norm(case2)" * doctest::test_suite("view::layer_norm"))
{
...
TEST_CASE("layer_norm(case3)" * doctest::test_suite("view::layer_norm"))
{
...
TEST_CASE("layer_norm_subtract_mean(case1)" * doctest::test_suite("view::layer_norm"))
{
    LAYER_NORM_SUBTRACT_MEAN_SUBCASE( case1, input, axis );
}