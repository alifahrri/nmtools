...
{ \
    ...
    auto result = nmtools::view::outer(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("outer(case1)" * doctest::test_suite("view::outer"))
{
...
TEST_CASE("outer(case1b)" * doctest::test_suite("view::outer"))
{
...
TEST_CASE("outer(case1c)" * doctest::test_suite("view::outer"))
{
...
TEST_CASE("outer(case2)" * doctest::test_suite("view::outer"))
{
...
TEST_CASE("outer(case2b)" * doctest::test_suite("view::outer"))
{
...
TEST_CASE("outer(case2c)" * doctest::test_suite("view::outer"))
{
