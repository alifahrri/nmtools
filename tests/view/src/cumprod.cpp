...
TEST_CASE("cumprod(case1)" * doctest::test_suite("view::cumprod"))
{
...
TEST_CASE("cumprod(case2)" * doctest::test_suite("view::cumprod"))
{
...
TEST_CASE("cumprod(case3)" * doctest::test_suite("view::cumprod"))
{
