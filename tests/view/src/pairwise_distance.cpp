...
{ \
    ...
    auto result = nmtools::view::pairwise_distance(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("pairwise_distance(case1a)" * doctest::test_suite("view::pairwise_distance"))
{
...
TEST_CASE("pairwise_distance(case1b)" * doctest::test_suite("view::pairwise_distance"))
{
...
TEST_CASE("pairwise_distance(case1c)" * doctest::test_suite("view::pairwise_distance"))
{
    auto ord = 2;
    auto eps = 1e-6;
...
TEST_CASE("pairwise_distance(case1d)" * doctest::test_suite("view::pairwise_distance"))
{
    auto ord = 2;
    auto eps = 1e-6;
...
TEST_CASE("pairwise_distance(case2a)" * doctest::test_suite("view::pairwise_distance"))
{
...
TEST_CASE("pairwise_distance(case2b)" * doctest::test_suite("view::pairwise_distance"))
{
...
TEST_CASE("pairwise_distance(case2c)" * doctest::test_suite("view::pairwise_distance"))
{
...
TEST_CASE("pairwise_distance(case2d)" * doctest::test_suite("view::pairwise_distance"))
{
...
TEST_CASE("pairwise_distance(case2e)" * doctest::test_suite("view::pairwise_distance"))
{
    auto eps = 1e-6;
...
TEST_CASE("pairwise_distance(case2f)" * doctest::test_suite("view::pairwise_distance"))
{
    auto eps = 1e-6;
