...
{ \
    ...
    auto result = nmtools::view::dstack(__VA_ARGS__); \
    NMTOOLS_ASSERT_EQUAL( nmtools::shape(result), nmtools::shape(expect::result) ); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

TEST_CASE("dstack(case1)" * doctest::test_suite("view::dstack"))
{
...
TEST_CASE("dstack(case2)" * doctest::test_suite("view::dstack"))
{
...
TEST_CASE("dstack(case2b)" * doctest::test_suite("view::dstack"))
{
...
TEST_CASE("dstack(case3)" * doctest::test_suite("view::dstack"))
{
...
TEST_CASE("dstack(case4)" * doctest::test_suite("view::dstack"))
{
