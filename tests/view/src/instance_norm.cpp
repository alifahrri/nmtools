...
{ \
    ...
    auto result = nmtools::view::instance_norm(__VA_ARGS__); \
...
{ \
    NMTOOLS_TESTING_USE_CASE(array, instance_norm, case_name); \
    using namespace args; \
    auto result = nmtools::view::instance_norm_1d(__VA_ARGS__); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}
...
{ \
    NMTOOLS_TESTING_USE_CASE(array, instance_norm, case_name); \
    using namespace args; \
    auto result = nmtools::view::instance_norm_2d(__VA_ARGS__); \
    NMTOOLS_ASSERT_CLOSE( result, expect::result ); \
}

using namespace nmtools::literals;

TEST_CASE("instance_norm(case1)" * doctest::test_suite("view::instance_norm"))
{
...
TEST_CASE("instance_norm(case2)" * doctest::test_suite("view::instance_norm"))
{
