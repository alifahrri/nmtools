...
#include "nmtools/testing/data/constexpr/atleast_2d.hpp"
#include "nmtools/testing/doctest.hpp"

#define CONSTEXPR_ATLEAST_2D_SUBCASE(case_name, ...) \
SUBCASE(#case_name) \
{ \
    NMTOOLS_TESTING_USE_CASE(array, constexpr_atleast_2d, case_name); \
    using namespace args; \
    constexpr auto result = nmtools::array::atleast_2d(__VA_ARGS__); \
