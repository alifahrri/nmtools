...
TEST_CASE("add.outer_nd(case1a)" * doctest::test_suite("simd::vector_256"))
{
...
#if 1
TEST_CASE("add.outer_nd(case1b)" * doctest::test_suite("simd::vector_256"))
{
    auto dtype = nm::int32;
    auto lhs_shape = nmtools_array{2,3};
    auto rhs_shape = nmtools_array{4,5,6};
...
TEST_CASE("add.outer_nd(case2a)" * doctest::test_suite("simd::vector_256"))
{
    auto dtype = nm::float32;
...
#if 1
TEST_CASE("add.outer_nd(case2b)" * doctest::test_suite("simd::vector_256"))
{
    auto dtype = nm::int32;
    auto lhs_shape = nmtools_array{1,4,2,3};
...
TEST_CASE("multiply.outer_nd(case1a)" * doctest::test_suite("simd::vector_256"))
{
    auto dtype = nm::float32;
    auto lhs_shape = nmtools_array{2,3};
    auto rhs_shape = nmtools_array{4,5,6};
...
#if 0
TEST_CASE("multiply.outer_nd(case1d)" * doctest::test_suite("simd::vector_256"))
{
    auto dtype = nm::int64;
    auto lhs_shape = nmtools_array{2,3};
    auto rhs_shape = nmtools_array{4,5,6};
...
TEST_CASE("multiply.outer_nd(case2a)" * doctest::test_suite("simd::vector_256"))
{
    auto dtype = nm::float32;
    auto lhs_shape = nmtools_array{1,4,2,3};
    auto rhs_shape = nmtools_array{4,5,1,6};
...
#if 0
TEST_CASE("multiply.outer_nd(case2d)" * doctest::test_suite("simd::vector_256"))
{
    auto dtype = nm::int64;
    auto lhs_shape = nmtools_array{1,4,2,3};
    auto rhs_shape = nmtools_array{4,5,1,9};
