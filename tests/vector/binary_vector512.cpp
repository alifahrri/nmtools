...
{ \
    ...
    auto result = na::fn(array,##__VA_ARGS__,nm::casting::same_kind_t{},simd::vector_512); \
...
#if 1
TEST_CASE("add(case1)" * doctest::test_suite("simd::vector_512"))
{
    auto lhs  = na::arange(128);
    auto rhs  = na::arange(128);
    VECTOR_512_TEST(lhs,add,rhs);
}

TEST_CASE("add(case2)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case3)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case4)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case5)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case6)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case7)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case8)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case9)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case10)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case11)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case12)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case13)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case14)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case15)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case16)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case17)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case18)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case19)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case20)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case21)" * doctest::test_suite("simd::vector_512") * doctest::skip())
{
...
TEST_CASE("add(case22)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case23)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case24)" * doctest::test_suite("simd::vector_512"))
{
...
TEST_CASE("add(case25)" * doctest::test_suite("simd::vector_512"))
{
