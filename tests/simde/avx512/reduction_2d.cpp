...
TEST_CASE("add.reduce_2d(case1a)" * doctest::test_suite("simd::simde_AVX512"))
{
    auto M = 3;
    auto N = 4;
    ...
    SIMDE_AVX512_TEST(add.reduce,input,axis,dtype,initial,keepdims);
}
...
#if 1
TEST_CASE("add.reduce_2d(case3c)" * doctest::test_suite("simd::simde_AVX512"))
{
    auto M = 4;
    auto N = 10;
    auto axis = meta::ct_v<1>;
...
TEST_CASE("add.reduce_2d(case4a)" * doctest::test_suite("simd::simde_AVX512"))
{
    auto M = 8;
    auto N = 20;
    auto axis = meta::ct_v<0>;
...
TEST_CASE("add.reduce_2d(case5a)" * doctest::test_suite("simd::simde_AVX512"))
{
    auto M = 12;
    auto N = 26;
    auto axis = meta::ct_v<0>;
...
TEST_CASE("add.reduce_2d(case10a)" * doctest::test_suite("simd::simde_AVX512"))
{
    auto M = 13;
    auto N = 29;
    auto axis = meta::ct_v<0>;
...
TEST_CASE("multiply.reduce_2d(case1a)" * doctest::test_suite("simd::simde_AVX512"))
{
    auto M = 3;
    auto N = 4;
    auto axis = meta::ct_v<0>;
    ...
    auto initial   = nm::None;
    auto keepdims  = nm::True;
    SIMDE_AVX512_TEST(multiply.reduce,input,axis,dtype,initial,keepdims);
}
...
#if 1
// TODO; fix precision
TEST_CASE("multiply.reduce_2d(case3c)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 4;
    auto N = 10;
    auto axis = meta::ct_v<1>;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case3d)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 4;
    auto N = 10;
    auto axis = 1;
...
TEST_CASE("multiply.reduce_2d(case4a)" * doctest::test_suite("simd::simde_AVX512"))
{
    auto M = 8;
    auto N = 20;
    auto axis = meta::ct_v<0>;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case4c)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 8;
    auto N = 20;
    auto axis = meta::ct_v<1>;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case4d)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 8;
    auto N = 20;
    auto axis = 1;
...
TEST_CASE("multiply.reduce_2d(case5a)" * doctest::test_suite("simd::simde_AVX512"))
{
    auto M = 12;
    auto N = 26;
    auto axis = meta::ct_v<0>;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case5c)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 12;
    auto N = 26;
    auto axis = meta::ct_v<1>;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case5d)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 12;
    auto N = 26;
    auto axis = 1;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case6c)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 13;
    auto N = 29;
    auto axis = meta::ct_v<1>;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case6d)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 13;
    auto N = 29;
    auto axis = 1;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case8c)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 13;
    auto N = 29;
    auto axis = meta::ct_v<1>;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case8d)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 13;
    auto N = 29;
    auto axis = 1;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case9c)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 13;
    auto N = 29;
    auto axis = meta::ct_v<1>;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case9d)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 13;
    auto N = 29;
    auto axis = 1;
...
TEST_CASE("multiply.reduce_2d(case10a)" * doctest::test_suite("simd::simde_AVX512"))
{
    auto M = 13;
    auto N = 29;
    auto axis = meta::ct_v<0>;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case10c)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 13;
    auto N = 29;
    auto axis = meta::ct_v<1>;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case10d)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 13;
    auto N = 29;
    auto axis = 1;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case11b)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 14;
    auto N = 29;
    auto axis  = 1;
...
// TODO: fix precision
TEST_CASE("multiply.reduce_2d(case11d)" * doctest::test_suite("simd::simde_AVX512") * doctest::may_fail())
{
    auto M = 14;
    auto N = 29;
    auto axis  = 1;
...
#if 0
TEST_CASE("multiply.reduce_2d(case14a)" * doctest::test_suite("simd::simde_AVX512"))
{
    auto M = 14;
    auto N = 29;
    auto axis  = 0;
