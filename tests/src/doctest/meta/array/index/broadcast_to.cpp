...
TEST_CASE("broadcast_to(vector;vector)" * doctest::test_suite("index::broadcast_to"))
{
    {
        using lhs_t = std::vector<int>;
        using rhs_t = std::vector<int>;
        using res_t = meta::resolve_optype_t<nm::index::broadcast_to_t,lhs_t,rhs_t>;
        using exp_t = std::vector<int>;
        STATIC_CHECK_IS_SAME( res_t, exp_t );
    }
}

TEST_CASE("broadcast_to(array;array)" * doctest::test_suite("index::broadcast_to"))
{
    {
...
TEST_CASE("broadcast_to(tuple;tuple)" * doctest::test_suite("index::broadcast_to"))
{
    {
...
TEST_CASE("broadcast_to(hybrid_ndarray;hybrid_ndarray)" * doctest::test_suite("index::broadcast_to"))
{
    {
...
TEST_CASE("broadcast_to(vector;any)" * doctest::test_suite("index::broadcast_to"))
{
    {
        using lhs_t = std::vector<int>;
        using rhs_t = std::tuple<int,int,int>;
...
TEST_CASE("broadcast_to(array;any)" * doctest::test_suite("index::broadcast_to"))
{
    {
...
TEST_CASE("broadcast_to(raw,tuple)" * doctest::test_suite("index::broadcast_to"))
{
    {
        using lhs_t = int[3];
...
TEST_CASE("broadcast_to(array,tuple)" * doctest::test_suite("index::broadcast_to"))
{
