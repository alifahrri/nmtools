...
TEST_CASE("view::mutable_slice") // mutable_slice with 1D std::array
{
...
TEST_CASE("view::mutable_slice") // make_view<slice_t>
{
...
TEST_CASE("view::mutable_slice") // mutable_slice with 1D std::vector
{
...
TEST_CASE("view::mutable_slice") // mutable_slice with 1D std::vector
{
    ...
    array_ref(0) = 3;
    CHECK( nmtools::at(array,1)==3 );

    // @todo make sure is_fixed_size, fixed_vector_size, fixed_array_shape is preserved
}

TEST_CASE("view::mutable_slice") // mutable_slice with 2D fixed_ndarray
{
    ...
    CHECK( nmtools::at(array,1,1)==6 );
    CHECK( nmtools::at(array,2,0)==7 );
