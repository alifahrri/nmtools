...
TEST_CASE("flatten(double[N])" * doctest::test_suite("view::flatten"))
{
...
TEST_CASE("flatten(double[2][3])" * doctest::test_suite("view::flatten"))
{
    double array[2][3] = {
        {1.,2.,3.},
        {3.,4.,5.},
...
TEST_CASE("flatten(double[2][3][1])" * doctest::test_suite("view::flatten"))
{
    double array[2][3][1] = {
        {{1.},{2.},{3.}},
        {{3.},{4.},{5.}},
...
TEST_CASE("flatten(fixed_ndarray[3])" * doctest::test_suite("view::flatten"))
{
    ...
    CHECK( array_ref.dim()==1 );
    CHECK( isequal(array_ref.shape(),std::array{3*2*3}) );
...
TEST_CASE("flatten(fixed_ndarary[4])" * doctest::test_suite("view::flatten"))
{
    ...
    CHECK( array_ref.dim()==1 );
    CHECK( isequal(array_ref.shape(),std::array{2*3*4*1}) );
...
TEST_CASE("flatten(fixed_ndarary[5])" * doctest::test_suite("view::flatten"))
{
    ...
    CHECK( array_ref.dim()==1 );
    CHECK( isequal(array_ref.shape(),std::array{2*3*4*1*2}) );
