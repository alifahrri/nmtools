...
TEST_CASE("expand_dims(vector)" * doctest::test_suite("index"))
{
    {
    ...
    }
    {
        ...
        auto newshape = nm::index::expand_dims(shape,axes);
        auto expected = std::vector{1,1,2,1,3};
        NMTOOLS_ASSERT_EQUAL( newshape, expected );
    }
    {
        auto shape = std::vector{1,2,3};
        ...
        auto newshape = nm::index::expand_dims(shape,axes);
        auto expected = std::vector{1,2,1,3,1};
        NMTOOLS_ASSERT_EQUAL( newshape, expected );
    }
    {
        auto shape = std::vector{1,2,3};
        ...
        auto newshape = nm::index::expand_dims(shape,axes);
        auto expected = std::vector{1,1,2,1,3,1};
        NMTOOLS_ASSERT_EQUAL( newshape, expected );
    }
...
TEST_CASE("expand_dims(array)" * doctest::test_suite("index"))
{
    {
    ...
    }
    {
        ...
        auto axes  = std::array{1,2};
        auto newshape = nm::index::expand_dims(shape,axes);
        auto expected = std::array{1,1,2,1,3};
        NMTOOLS_ASSERT_EQUAL( newshape, expected );
    }
    {
        auto shape = std::array{1,2,3};
        auto axes  = std::array{2,3};
        auto newshape = nm::index::expand_dims(shape,axes);
        auto expected = std::array{1,2,1,3,1};
        NMTOOLS_ASSERT_EQUAL( newshape, expected );
    }
    {
        auto shape = std::array{1,2,3};
        auto axes  = std::array{2,3,0};
        auto newshape = nm::index::expand_dims(shape,axes);
        auto expected = std::array{1,1,2,1,3,1};
        NMTOOLS_ASSERT_EQUAL( newshape, expected );
    }
...
TEST_CASE("expand_dims(tuple)" * doctest::test_suite("index"))
{
    {
